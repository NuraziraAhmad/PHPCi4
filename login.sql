...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 06, 2020 at 05:17 PM
...
CREATE TABLE `answers` (
  `id` int(11) NOT NULL,
  `firstquestion` varchar(50) NOT NULL,
  `secondquestion` varchar(50) NOT NULL,
  `thirdquestion` varchar(50) NOT NULL,
  `fourtquestion` varchar(255) NOT NULL
